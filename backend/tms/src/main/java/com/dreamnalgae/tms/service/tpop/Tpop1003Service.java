...
public class Tpop1003Service {
    private final NamedParameterJdbcTemplate jdbc;

    public List<Map<String, Object>> selectCustList(String keyword, String custDivGb, String sosokNm, String useYn) {
        ...
        // if (sosokNm != null && !sosokNm.isEmpty()) {
        //     sql.append(" AND SOSOK_NM = :sosokNm\n");
        //     params.put("sosokNm", sosokNm);
        // }
    ...
    public List<Map<String, Object>> selectSosokList() {
        String sql = """
            SELECT DISTINCT SOSOK_NM
            FROM TMS_CUST
            WHERE SOSOK_NM IS NOT NULL
            ORDER BY SOSOK_NM
        """;
