/*
 * File: app/store/popup/custStore.js
 *
...
Ext.define('TmsLabel.store.popup.custStore', {
    extend: 'Ext.data.Store',

    requires: [
        'TmsLabel.model.popup.custVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'popup.custStore',
            model: 'TmsLabel.model.popup.custVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
