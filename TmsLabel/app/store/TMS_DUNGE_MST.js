/*
 * File: app/store/TMS_DUNGE_MST.js
 *
...
Ext.define('TmsLabel.store.TMS_DUNGE_MST', {
    extend: 'Ext.data.Store',

    requires: [
        'TmsLabel.model.TMS_DUNGE_MST',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'TMS_DUNGE_MST',
            model: 'TmsLabel.model.TMS_DUNGE_MST',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
