/*
 * File: app/store/tord/tord1002/order.js
 *
...
Ext.define('dream.store.tord.tord1002.order', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tord.tord1002.order',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tord.tord1002.order',
            model: 'dream.model.tord.tord1002.order',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
