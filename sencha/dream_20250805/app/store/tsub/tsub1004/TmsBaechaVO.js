/*
 * File: app/store/tsub/tsub1004/TmsBaechaVO.js
 *
...
Ext.define('dream.store.tsub.tsub1004.TmsBaechaVO', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsub.tsub1004.TmsBaechaVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsub.tsub1004.TmsBaechaVO',
            model: 'dream.model.tsub.tsub1004.TmsBaechaVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
