/*
 * File: app/store/tbas/tbas1003/cet_publish.js
 *
...
Ext.define('dream.store.tbas.tbas1003.cet_publish', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.tbas1003.cet_publish',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.tbas1003.cet_publish',
            model: 'dream.model.tbas.tbas1003.cet_publish',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
