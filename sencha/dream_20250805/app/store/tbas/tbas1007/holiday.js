/*
 * File: app/store/tbas/tbas1007/holiday.js
 *
...
Ext.define('dream.store.tbas.tbas1007.holiday', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.tbas1007.holiday',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.tbas1007.holiday',
            model: 'dream.model.tbas.tbas1007.holiday',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
