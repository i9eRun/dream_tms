/*
 * File: app/store/tbas/tbas1001/custInfoStore.js
 *
...
Ext.define('dream.store.tbas.tbas1001.custInfoStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.tbas1001.custInfoModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.tbas1001.custInfoStore',
            model: 'dream.model.tbas.tbas1001.custInfoModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
