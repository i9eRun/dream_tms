/*
 * File: app/store/tpop/tpop0116/search.js
 *
...
Ext.define('dream.store.tpop.tpop0116.search', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tpop.tpop1006.sujumVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tpop.tpop0116.search',
            model: 'dream.model.tpop.tpop1006.sujumVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
