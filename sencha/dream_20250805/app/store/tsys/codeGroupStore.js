/*
 * File: app/store/tsys/codeGroupStore.js
 *
...
Ext.define('dream.store.tsys.codeGroupStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsys.codeGroupModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsys.codeGroupStore',
            model: 'dream.model.tsys.codeGroupModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
