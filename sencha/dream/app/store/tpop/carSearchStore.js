/*
 * File: app/store/tpop/carSearchStore.js
 *
...
Ext.define('dream.store.tpop.carSearchStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tpop.carSearchModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tpop.carSearchStore',
            model: 'dream.model.tpop.carSearchModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
