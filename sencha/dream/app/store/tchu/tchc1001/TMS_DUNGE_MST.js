/*
 * File: app/store/tchu/tchc1001/TMS_DUNGE_MST.js
 *
...
Ext.define('dream.store.tchu.tchc1001.TMS_DUNGE_MST', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tchu.TMS_DUNGE_MST',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tchu.tchc1001.TMS_DUNGE_MST',
            model: 'dream.model.tchu.TMS_DUNGE_MST',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
