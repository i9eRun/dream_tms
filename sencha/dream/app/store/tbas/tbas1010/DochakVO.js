/*
 * File: app/store/tbas/tbas1010/DochakVO.js
 *
...
Ext.define('dream.store.tbas.tbas1010.DochakVO', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.tbas1010.DochakVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.tbas1010.DochakVO',
            model: 'dream.model.tbas.tbas1010.DochakVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
