/*
 * File: app/store/tbas/tbas1004/publish.js
 *
...
Ext.define('dream.store.tbas.tbas1004.publish', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.tbas1004.publish',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.tbas1004.publish',
            model: 'dream.model.tbas.tbas1004.publish',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
