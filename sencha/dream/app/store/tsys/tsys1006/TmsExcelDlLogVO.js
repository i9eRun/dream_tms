/*
 * File: app/store/tsys/tsys1006/TmsExcelDlLogVO.js
 *
...
Ext.define('dream.store.tsys.tsys1006.TmsExcelDlLogVO', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsys.tsys1006.TmsExcelDlLogVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsys.tsys1006.TmsExcelDlLogVO',
            model: 'dream.model.tsys.tsys1006.TmsExcelDlLogVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
