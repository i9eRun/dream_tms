/*
 * File: app/store/treo/treo1003/orderRetnMst.js
 *
...
Ext.define('dream.store.treo.treo1003.orderRetnMst', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.treo.treo1003.orderRetnMst',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'treo.treo1003.orderRetnMst',
            model: 'dream.model.treo.treo1003.orderRetnMst',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
