/*
 * File: app/store/tord/tord1001/excel.js
 *
...
Ext.define('dream.store.tord.tord1001.excel', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tord.tord1001.excelVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tord.tord1001.excel',
            model: 'dream.model.tord.tord1001.excelVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
