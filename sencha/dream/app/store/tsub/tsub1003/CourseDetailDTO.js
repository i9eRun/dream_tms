/*
 * File: app/store/tsub/tsub1003/CourseDetailDTO.js
 *
...
Ext.define('dream.store.tsub.tsub1003.CourseDetailDTO', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsub.tsub1003.CourseDetailDTO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsub.tsub1003.CourseDetailDTO',
            model: 'dream.model.tsub.tsub1003.CourseDetailDTO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
