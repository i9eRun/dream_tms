/*
 * File: app/store/tsub/tsub1005/itemVO.js
 *
...
Ext.define('dream.store.tsub.tsub1005.itemVO', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsub.tsub1005.itemVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsub.tsub1005.itemVO',
            model: 'dream.model.tsub.tsub1005.itemVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
