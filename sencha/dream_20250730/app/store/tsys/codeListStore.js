/*
 * File: app/store/tsys/codeListStore.js
 *
...
Ext.define('dream.store.tsys.codeListStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsys.codeListModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsys.codeListStore',
            model: 'dream.model.tsys.codeListModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
