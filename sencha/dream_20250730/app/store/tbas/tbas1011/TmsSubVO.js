/*
 * File: app/store/tbas/tbas1011/TmsSubVO.js
 *
...
Ext.define('dream.store.tbas.tbas1011.TmsSubVO', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.tbas1011.TmsSubVo',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.tbas1011.TmsSubVO',
            model: 'dream.model.tbas.tbas1011.TmsSubVo',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
