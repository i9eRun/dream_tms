/*
 * File: app/store/tsys/TmsCusUserStore.js
 *
...
Ext.define('dream.store.tsys.TmsCusUserStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsys.TmsCusUserModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsys.TmsCusUserStore',
            model: 'dream.model.tsys.TmsCusUserModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
