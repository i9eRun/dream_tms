/*
 * File: app/store/tsys/userListStore.js
 *
...
Ext.define('dream.store.tsys.userListStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsys.userListModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsys.userListStore',
            model: 'dream.model.tsys.userListModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
