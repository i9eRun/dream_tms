/*
 * File: app/store/tsys/TmsCusStore.js
 *
...
Ext.define('dream.store.tsys.TmsCusStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsys.TmsCusModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsys.TmsCusStore',
            model: 'dream.model.tsys.TmsCusModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
