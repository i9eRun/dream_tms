/*
 * File: app/store/tsys/groupUserGridStore.js
 *
...
Ext.define('dream.store.tsys.groupUserGridStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsys.groupUserGridModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsys.groupUserGridStore',
            model: 'dream.model.tsys.groupUserGridModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
