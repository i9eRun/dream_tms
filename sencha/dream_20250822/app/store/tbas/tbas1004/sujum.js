/*
 * File: app/store/tbas/tbas1004/sujum.js
 *
...
Ext.define('dream.store.tbas.tbas1004.sujum', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.tbas1004.sujum',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.tbas1004.sujum',
            model: 'dream.model.tbas.tbas1004.sujum',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
