/*
 * File: app/store/treo/treo1004/TmsJaechulgoVO.js
 *
...
Ext.define('dream.store.treo.treo1004.TmsJaechulgoVO', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.treo.treo1004.TmsJaechulgoVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'treo.treo1004.TmsJaechulgoVO',
            model: 'dream.model.treo.treo1004.TmsJaechulgoVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
