/*
 * File: app/store/tpop/tpop1006/search_list.js
 *
...
Ext.define('dream.store.tpop.tpop1006.search_list', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tpop.tpop1006.ChulpanSujumVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tpop.tpop1006.search_list',
            model: 'dream.model.tpop.tpop1006.ChulpanSujumVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
