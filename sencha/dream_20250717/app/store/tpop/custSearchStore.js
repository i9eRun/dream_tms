/*
 * File: app/store/tpop/custSearchStore.js
 *
...
Ext.define('dream.store.tpop.custSearchStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tpop.custSearchModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tpop.custSearchStore',
            model: 'dream.model.tpop.custSearchModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
