/*
 * File: app/store/tsys/TmsGroupMStore.js
 *
...
Ext.define('dream.store.tsys.TmsGroupMStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tsys.TmsGroupMVO',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tsys.TmsGroupMStore',
            model: 'dream.model.tsys.TmsGroupMVO',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
