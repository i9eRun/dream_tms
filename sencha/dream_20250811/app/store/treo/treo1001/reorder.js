/*
 * File: app/store/treo/treo1001/reorder.js
 *
...
Ext.define('dream.store.treo.treo1001.reorder', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.treo.treo1001.reorder',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'treo.treo1001.reorder',
            model: 'dream.model.treo.treo1001.reorder',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
