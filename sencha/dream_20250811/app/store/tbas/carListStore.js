/*
 * File: app/store/tbas/carListStore.js
 *
...
Ext.define('dream.store.tbas.carListStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.carListModel',
        'dream.store.override.tbas.carListStore'
    ],
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.carListStore',
            model: 'dream.model.tbas.carListModel'
        }, cfg)]);
    }
});