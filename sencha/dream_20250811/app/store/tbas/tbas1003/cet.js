/*
 * File: app/store/tbas/tbas1003/cet.js
 *
...
Ext.define('dream.store.tbas.tbas1003.cet', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.tbas1003.cet',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.tbas1003.cet',
            model: 'dream.model.tbas.tbas1003.cet',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
