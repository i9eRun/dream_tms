/*
 * File: app/store/tbas/tbas1004/chulpanSujum.js
 *
...
Ext.define('dream.store.tbas.tbas1004.chulpanSujum', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.tbas1004.chulpanSujum',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.tbas1004.chulpanSujum',
            model: 'dream.model.tbas.tbas1004.chulpanSujum',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
