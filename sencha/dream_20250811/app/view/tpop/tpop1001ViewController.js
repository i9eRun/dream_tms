...
Ext.define('dream.view.tpop.tpop1001ViewController', {
    ...
    onTpop1001_cancel_buttonClick: function(button, e, eOpts) {
        button.up('window').close();
    },

    onTpop1001_keywordAfterRender: function(component, eOpts) {
        component.on('specialkey', function(component, e) {
            if (e.getKey() === e.ENTER) {
                const button = Ext.getCmp('tpop1001_search_btn');
                if (button) {
