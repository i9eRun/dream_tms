/*
 * File: app/store/tbas/deptCodeStore.js
 *
...
Ext.define('dream.store.tbas.deptCodeStore', {
    extend: 'Ext.data.Store',

    requires: [
        'dream.model.tbas.deptCodeModel',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            storeId: 'tbas.deptCodeStore',
            model: 'dream.model.tbas.deptCodeModel',
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
